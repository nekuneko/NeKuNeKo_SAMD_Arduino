...
/*
 * Pins descriptions for Sok Dark Dawn board
 */
 ...
 */
  ...
  { PORTA,  8, PIO_SERCOM,      (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),ADC_Channel16,  PWM1_CH2,   TCC1_CH2,     EXTERNAL_INT_NONE },  //  5 D5      SERCOM0_PAD[0] / AIN[16] / ALT_TCC1_WO[2] / NMI
  { PORTA, 11, PIO_SERCOM,      (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),ADC_Channel19,  PWM0_CH3,   TCC0_CH3,     EXTERNAL_INT_11   },  //  6 D6      SERCOM0_PAD[3] / AIN[19] / ALT_TCC0_WO[3] / INT_11
  { PORTB, 13, PIO_SERCOM,      (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),                No_ADC_Channel, PWM0_CH7,   TCC0_CH7,     EXTERNAL_INT_13   },  //  7 D7      SERCOM4_PAD[1] /         /     TCC0_WO[7] / INT_13*                                       
  
 
  // Digital High
  { PORTB, 12, PIO_SERCOM,      (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),                No_ADC_Channel, PWM0_CH6,   TCC0_CH6,     EXTERNAL_INT_12 },    //  8 D8      SERCOM4_PAD[0] /         /     TCC0_WO[6] / INT 12*
  { PORTB, 11, PIO_SERCOM_ALT,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),                No_ADC_Channel, PWM0_CH5,   TCC0_CH5,     EXTERNAL_INT_11 },    //  9 D9  ALT_SERCOM4/PAD[3] /         / ALT_TCC0_WO[5] / INT_11*
  { PORTB, 10, PIO_SERCOM_ALT,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),                No_ADC_Channel, PWM0_CH4,   TCC0_CH4,     EXTERNAL_INT_10 },    // 10 D10 ALT_SERCOM4_PAD[2] /         / ALT_TCC0_WO[4] / INT_10*
  ...
  // --------------------  
  { PORTA, 19, PIO_OUTPUT,      (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),                    No_ADC_Channel, PWM3_CH1,   TC3_CH1,      EXTERNAL_INT_3  },  // 14 D14                      /         /     TC3_WO[1]  / INT_3  / (lED_BUILTIN)
  { PORTA, 27, PIO_OUTPUT,      (PIN_ATTR_DIGITAL),                                                No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15 },  // 15 D15                      /         /                / INT_15 / (BLE_RESET)    
  { PORTA, 21, PIO_OUTPUT,      (PIN_ATTR_DIGITAL),                                                No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5  },  // 16 D16                      /         /                / INT_5  / (BLE_ENABLE) 
  { PORTB, 31, PIO_OUTPUT,      (PIN_ATTR_DIGITAL),                                                No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15 },  // 17 D17                      /         /                / INT_15 / (BLE_CONFIG)      
  { PORTA, 23, PIO_OUTPUT,      (PIN_ATTR_DIGITAL),                                                No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7  },  // 18 D18                      /         /                / INT_7  / (BLE_MSTR_SLV)
  ...
  { PORTA, 28, PIO_OUTPUT,      (PIN_ATTR_DIGITAL),                                                No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8  },  // 24 D24                      /         /                / INT_8  / (NC, VSF)      
  ...
  { PORTA,  8, PIO_SERCOM,      (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), ADC_Channel16, PWM1_CH2,   TCC1_CH2,     EXTERNAL_INT_NONE },  // 40 A15      SERCOM0_PAD[0]  / AIN[16] / ALT_TCC1_WO[2] / NMI    / (D5)
  { PORTA, 11, PIO_SERCOM,      (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), ADC_Channel19, PWM0_CH3,   TCC0_CH3,     EXTERNAL_INT_11 },    // 41 A16      SERCOM0_PAD[3]  / AIN[19] / ALT_TCC0_WO[3] / INT_11 / (D6)
  ...
  // ----------------------
  { PORTB,  8, PIO_SERCOM_ALT,  (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),     ADC_Channel2,  PWM4_CH0,   TC4_CH0,      EXTERNAL_INT_8 },     // 45 SDA  ALT_SERCOM4_PAD[0]  / AIN[2]  /     TC4_WO[0]  / INT_8* / (I2C_SDA, EXTERNAL)
  { PORTB,  9, PIO_SERCOM_ALT,  (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),     ADC_Channel3,  PWM4_CH1,   TC4_CH1,      EXTERNAL_INT_9 },     // 46 SCL  ALT_SERCOM4_PAD[1]  / AIN[3]  /     TC4_WO[1]  / INT_9  / (I2C_SCL, EXTERNAL)
  

  // 47...48 Secondary I2C pins (INTERNAL I2C SDA1/SCL1)
  // ----------------------
  { PORTA, 16, PIO_SERCOM,      (PIN_ATTR_DIGITAL),                                               No_ADC_Channel,  NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0 },     // 47 SDA1      SERCOM1/PAD[0] /         /                / INT_0  / (I2C_SDA, INTERNAL) 
  { PORTA, 17, PIO_SERCOM,      (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),                   No_ADC_Channel,  PWM2_CH1,   TCC2_CH1,     EXTERNAL_INT_1 },     // 48 SCL1      SERCOM1/PAD[1] /         /    TCC2_WO[1]  / INT_1  / (I2C_SCL, INTERNAL)


  // 49...51 Primary SPI pins (EXTERNAL SPI: MOSI, SCK, MISO)
  // ----------------------
  { PORTA, 30, PIO_SERCOM,  (PIN_ATTR_DIGITAL),                                               No_ADC_Channel,  NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_10 },   // 49 MOSI          SERCOM7/PAD[2]  /         /                / INT_10 / (SPI_MOSI, EXTERNAL) 
  { PORTA, 31, PIO_SERCOM,  (PIN_ATTR_DIGITAL),                                               No_ADC_Channel,  NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_11 },   // 50 SCK           SERCOM7/PAD[3]  /         /                / INT_11 / (SPI_SCK,  EXTERNAL)
  { PORTB, 30, PIO_SERCOM,  (PIN_ATTR_DIGITAL),                                               No_ADC_Channel,  NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_14 },   // 18 MISO          SERCOM7/PAD[0]  /         /                / INT_14 / (SPI_MISO, EXTERNAL) 

  // 52...54 Secondary SPI pins (INTERNAL SPI1: MOSI1, SCK1, MISO1)
  // ----------------------
  { PORTA, 15, PIO_SERCOM,      (PIN_ATTR_DIGITAL),                                               No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15 },  // 52 MOSI1       SERCOM2/PAD[3]  /         /                / INT_15 / (SPI_MOSI, INTERNAL)
  { PORTA, 13, PIO_SERCOM,      (PIN_ATTR_DIGITAL),                                               No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_13 },  // 53 SCK1        SERCOM2/PAD[1]  /         /                / INT_13 / (SPI_SCK,  INTERNAL)
  { PORTA, 12, PIO_SERCOM,      (PIN_ATTR_DIGITAL),                                               No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_12 },  // 54 MISO1       SERCOM2/PAD[0]  /         /                / INT_12 / (SPI_MISO, INTERNAL)                         
  ...
  // --------------------
  { PORTB, 22, PIO_SERCOM_ALT,      (PIN_ATTR_DIGITAL),                                           No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 },  // 57 TX       ALT_SERCOM5/PAD[2]  /         /                / INT_6  / (SerialBLE, SAM_TX_BLE_RX)
  { PORTB, 23, PIO_SERCOM_ALT,      (PIN_ATTR_DIGITAL),                                           No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 },  // 58 RX       ALT_SERCOM5/PAD[3]  /         /                / INT_7  / (SerialBLE, SAM_RX_BLE_TX)               
