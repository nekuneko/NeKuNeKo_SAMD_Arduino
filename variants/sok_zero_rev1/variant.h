...
#define analogInputToDigitalPin(p)  ((p < 10u) ? (p) + 24u : -1)
...
#define PIN_SPI_SS           (16u)            // SPI_EXT_CS
...
#define PIN_SPI1_SS          (15u)            // SPI_INT_CS
...
// WIRE1 = I2C INTERNAL
#define PIN_WIRE1_SDA         (36u)
#define PIN_WIRE1_SCL         (37u)
