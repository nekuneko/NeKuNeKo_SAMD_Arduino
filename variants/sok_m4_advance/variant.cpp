 ...
 */
  ...
  { PORTA,  5, PIO_SERCOM_ALT,  (PIN_ATTR_DIGITAL|PIN_ATTR_ANALOG), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 },   //  1 D1   ALT_SERCOM0_PAD[1] / AIN[5]  /  DAC_Channel1 / INT_5   / (Serial1_RX) / DAC1 / VOUT1

  // 2...13
  // Digital Low
  { PORTA,  6, PIO_SERCOM_ALT,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E),  No_ADC_Channel, TC1_CH0,    TC1_CH0,      EXTERNAL_INT_6  },  //  2 D2   ALT_SERCOM0_PAD[2] / AIN[6]  /  E__TC1_WO[1] / INT_6 
  ...
  { PORTA,  7, PIO_SERCOM_ALT,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E),  No_ADC_Channel, TC1_CH1,    TC1_CH1,      EXTERNAL_INT_7  },  // 10 D10  ALT_SERCOM0_PAD[3] / AIN[7]  /  E__TC1_WO[1] / INT_7
  ...
  // --------------------
  { PORTB,  0, PIO_ANALOG,      (PIN_ATTR_ANALOG),                    ADC_Channel12, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0    },  // 25 A0                       / AIN[12] /               / INT_0*
  { PORTB,  1, PIO_ANALOG,      (PIN_ATTR_ANALOG),                    ADC_Channel13, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_1    },  // 26 A1                       / AIN[13] /               / INT_1* 
  ...
  { PORTA,  5, PIO_SERCOM_ALT,  (PIN_ATTR_ANALOG),                    ADC_Channel5,  NOT_ON_PWM, NOT_ON_PWM,   EXTERNAL_INT_5    },  // 36 A11  ALT_SERCOM0_PAD[1]  / AIN[5]  /  DAC_Channel1 / INT_5  / (D1, Serial_RX) / DAC1 / VOUT1
  { PORTA,  6, PIO_SERCOM_ALT,  (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E),     ADC_Channel6,  TCC1_CH0,   TCC1_CH0,     EXTERNAL_INT_6    },  // 37 A12  ALT_SERCOM0_PAD[0]  / AIN[6]  /  E__TC1_WO[1] / INT_6  / (D2)
  { PORTA, 11, PIO_SERCOM,      (PIN_ATTR_ANALOG|PIN_ATTR_PWM_G),     ADC_Channel11, TCC1_CH7,   TCC1_CH7,     EXTERNAL_INT_11   },  // 38 A16      SERCOM0_PAD[3]  / AIN[11] /  G_TCC1_WO[7] / INT_11 / (D3)
  ...
  { PORTA,  7, PIO_SERCOM_ALT,  (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E),     ADC_Channel7,  TC1_CH1,    TC1_CH1,      EXTERNAL_INT_7    },  // 41 A16  ALT_SERCOM0_PAD[1]  / AIN[7]  /  E__TC1_WO[1] / INT_7  / (D10)
  ...
  // ----------------------
  { PORTA, 31, PIO_SERCOM_ALT,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_F),  No_ADC_Channel, TCC2_CH1,   TCC2_CH1,     EXTERNAL_INT_11 },  // 49 MOSI  ALT_SERCOM1/PAD[2]  /         /                / INT_10 / (SPI_MOSI, EXTERNAL) 
  ...
  { PORTA, 30, PIO_SERCOM_ALT,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_F),  No_ADC_Channel, TCC2_CH0,   TCC2_CH0,     EXTERNAL_INT_10 },  // 51 MISO  ALT_SERCOM1/PAD[3]  /         /                / INT_11 / (SPI_SCK,  EXTERNAL)
