...
/*
 * Pins descriptions for Kitten Display
 * 
 */
 ...
 */
  ...
  { PORTA, 22, PIO_SERCOM,      (PIN_ATTR_DIGITAL),                                             No_ADC_Channel,   NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 },     //  0 D0     SERCOM3_PAD[0]  /         /                / INT_6 / (Serial1_TX)
  { PORTA, 23, PIO_SERCOM,      (PIN_ATTR_DIGITAL),                                             No_ADC_Channel,   NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 },     //  1 D1     SERCOM3_PAD[1]  /         /                / INT_7 / (Serial1_RX)
  ...
  { PORTA, 11, PIO_SERCOM,      (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),ADC_Channel19,  PWM0_CH3,   TCC0_CH3,     EXTERNAL_INT_11 },   //  5 D5      SERCOM0_PAD[3] / AIN[19] / ALT_TCC0_WO[3] / INT_11 / (I2S_FS[0])
  ...
  { PORTA,  9, PIO_TIMER,       (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),    ADC_Channel17,  PWM1_CH3,   TCC1_CH3,     EXTERNAL_INT_9 },    //  7 D7                     / AIN[17] /     TCC1_WO[3] / INT_9
  ...
  { PORTA, 17, PIO_SERCOM,      (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),             No_ADC_Channel,   PWM0_CH7,   TCC0_CH7,     EXTERNAL_INT_1  },    // 15 D15      SERCOM1/PAD[1] /         /     TCC0_WO[7] / INT_1   
  ...
  { PORTA, 10, PIO_SERCOM,      (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),ADC_Channel18, PWM0_CH2,   TCC0_CH2,     EXTERNAL_INT_10 },    // 20 A4      SERCOM0_PAD[2]  / AIN[18] / ALT_TCC0_WO[2] / INT_10 / (D4)
  { PORTA, 11, PIO_SERCOM,      (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),ADC_Channel19, PWM0_CH3,   TCC0_CH3,     EXTERNAL_INT_11 },    // 21 A5      SERCOM0_PAD[3]  / AIN[19] / ALT_TCC0_WO[3] / INT_11 / (D5)
  ...
  // 26...27 Primary I2C pins (SDA, SCL) - SERCOM2
  // ----------------------
  { PORTA,  8, PIO_SERCOM_ALT,  (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT),ADC_Channel16, PWM1_CH2,   TCC1_CH2,     EXTERNAL_INT_NONE },  // 26 D6  ALT_SERCOM2_PAD[0]  / AIN[16] / ALT_TCC1_WO[2] / NMI    / (A6)
  { PORTA,  9, PIO_SERCOM_ALT,  (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),    ADC_Channel17, PWM1_CH3,   TCC1_CH3,     EXTERNAL_INT_9 },     // 27 D7  ALT_SERCOM2_PAD[1]  / AIN[17] /     TCC1_WO[3] / INT_9  / (A7)
  ...
  { PORTA,  1, PIO_SERCOM_ALT,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER),                 No_ADC_Channel,   PWM2_CH1,   TCC2_CH1,     EXTERNAL_INT_1  },    // 29 SCK    ALT_SERCOM1/PAD[1] /         /  TCC2_WO[1]  / INT_1  / (SPI_SCK) 
...
SERCOM sercom2( SERCOM2 ) ; // Wire/SerialSOK
