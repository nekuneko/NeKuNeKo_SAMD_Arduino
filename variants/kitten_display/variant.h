...
#ifndef _VARIANT_KITTEN_DISPLAY_
#define _VARIANT_KITTEN_DISPLAY_
...
// Serial1 (D0/D1) - SERCOM3
#define PIN_SERIAL1_TX      (0ul)
#define PIN_SERIAL1_RX      (1ul)
#define PAD_SERIAL1_TX      (UART_TX_PAD_0)
#define PAD_SERIAL1_RX      (SERCOM_RX_PAD_1)

// SerialSOK (Alternate use of SERCOM2-I2C, TX-SDA, RX-SCL)
...
#endif /* _VARIANT_KITTEN_DISPLAY_ */
