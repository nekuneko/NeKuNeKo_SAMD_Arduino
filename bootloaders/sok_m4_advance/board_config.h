...
#define PRODUCT_NAME "SoK M4 Advance (SAMD51J20A)"
#define VOLUME_LABEL "SOK-M4-BOOT"
#define INDEX_URL "https://github.com/nekuneko/"
#define BOARD_ID "SAMD51J20A-SoK-M4-Advance"


#define USB_VID 0x1993
#define USB_PID 0xB001
...
const uint32_t config_data[] = {
    ...
    35, 0x21, // PIN_DISPLAY_CS = PIN_A1
    36, 0x20, // PIN_DISPLAY_DC = PIN_A0
    ...
    208, 0x1993b001, // BOOTLOADER_BOARD_ID = 0x1993b001
