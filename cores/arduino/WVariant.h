...
typedef enum _ETCChannel
{
  ...
  TCC0_CH4 = (0<<8)|(4),
  TCC0_CH5 = (0<<8)|(5),
  TCC0_CH6 = (0<<8)|(6), // Neku Was Here! Added in order to use TCC0_CH6 on SAMD51J
  TCC0_CH7 = (0<<8)|(7), // Neku Was Here! Added in order to use TCC0_CH7 on SAMD51J
  TCC1_CH0 = (1<<8)|(0),
  TCC1_CH1 = (1<<8)|(1),
  TCC1_CH2 = (1<<8)|(2),
  TCC1_CH3 = (1<<8)|(3),
  TCC1_CH4 = (1<<8)|(4), // Neku Was Here! Added in order to use TCC1_CH4 on SAMD51J
  TCC1_CH5 = (1<<8)|(5), // Neku Was Here! Added in order to use TCC1_CH5 on SAMD51J
  TCC1_CH6 = (1<<8)|(6), // Neku Was Here! Added in order to use TCC1_CH6 on SAMD51J
  TCC1_CH7 = (1<<8)|(7), // Neku Was Here! Added in order to use TCC1_CH7 on SAMD51J
  TCC2_CH0 = (2<<8)|(0),
  TCC2_CH1 = (2<<8)|(1),
  TCC2_CH2 = (2<<8)|(2),
  TCC3_CH0 = (3<<8)|(0),
