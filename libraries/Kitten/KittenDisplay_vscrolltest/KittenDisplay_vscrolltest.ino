...
#define TFT_LITE      DAC0
#define TFT_CS        -1
#define TFT_RST       A9 // Or set to -1 and connect to Arduino RESET pin
#define TFT_DC        A0
#endif
...
void setup(void) 
{
  ...
  // use this initializer (uncomment) if using a ST7789 240x240 TFT:
  //tft.init(240,240); 
